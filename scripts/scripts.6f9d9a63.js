...
UserService.$inject = ["$q", "$firebaseObject", "Ref", "user"];
...
(function() {
    ...
    LocationDetailController.$inject = ["LocationDetailService", "$routeParams", "$location", "user", "imgur", "IMGUR_API_KEY", "LocationVideoService", "UserService", "$modal"];
